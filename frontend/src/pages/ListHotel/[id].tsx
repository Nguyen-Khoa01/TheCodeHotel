                        ...
                        <div className="">
                            <div className="border-b-[1px] border-gray-300 pt-[25px] px-[20px] pb-[20px]">
                                ...
                                <div className="flex  items-center">
                                    ...
                                    <p className="text-[18px] text-[#333] lg:text-[15px]">{hotel.address},{hotel.city}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex px-[20px] pt-[15px] border-t-[1px] border-gray-300 pb-[25px] justify-between 2lg:flex-col md:flex-row">
                                <div>
                                    <h1 className="text-[22px] font-medium text-teal-600">${hotel.price} <span className="text-[16px] font-normal text-teal-600">/Night</span></h1>
