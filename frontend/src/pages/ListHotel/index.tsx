    ...
    if (checked) {
      switch (type) {
        case "AMENITIES":
          setFilter({
            ...filter,
            amenities: [...filter.amenities, item.lable],
          });
          break;
        case "STAR":
    ...
    <div className="">
      ...
      <div className="bg-[#F2F4F7] grid grid-cols-6 xl:grid-cols-1 ">
        <div className="col-start-2 col-span-4 xl:col-span-1 2xl:mx-[35px] 2md:mx-auto 2md:w-full lg:max-w-[720px] md:max-w-[540px]">
          <div
            className="flex py-[30px] mx-auto rounded bg-white  justify-around text-lg mt-7
                  ...
                  <div style={{ width: "100%" }} className="flex flex-col">
                    {Amenities.map((item, key) => (
                      <Checkbox
                        ...
                        value={item.value}
                        onChange={(e) =>
                          filterSelect("AMENITIES", e.target.checked, item)
                        }
                      >
                        {item.lable}
                      </Checkbox>
                ...
                <div className="flex flex-col mt-4 " ref={MenuRatingRef}>
                  {RatingHotel.map((item, key) => (
                    <Checkbox
                      ...
                      key={key}
                      onChange={(e) =>
                        filterSelect("STAR", e.target.checked, item)
                      }
                      className="text-[18px]"
                    >
                      {item.lable}
            ...
            <div className="col-span-2 my-10 ">
              ...
              <div className="grid grid-cols-2 gap-6 md:grid-cols-1">
                {ListHotel.map((item, key) => (
                  ...
                  >
                    <div className="">
                      <img className="w-full h-[192px]" src={item.avatar} />
                    </div>
                    <div className="">
                      <div className="border-b-[1px] border-gray-300 pt-[25px] px-[20px] pb-[20px]">
                        <div className="flex items-center rounded-md bg-[#0d948847] w-[100px] text-[18px] py-1 justify-center text-teal-600">
                          ...
                          <p className="mx-1">{item.starRating}</p>
                          <p>(380)</p>
                        </div>
                        <h1 className="text-[22px] my-2">{item.name}</h1>
