...
export default function Login() {
  ...
  return (
    <>
      {contextHolder}
      <div
        className="bg-white shadow-2xl max-w-[1300px] mx-auto rounded-xl 
        ...
        <div className="p-[30px] col-span-5">
          ...
          >
            ...
            <div className="grid grid-cols-2 ">
              ...
              <Form.Item className=" mx-auto mt-4 col-span-2 ">
                <Button
                  type="primary"
                  htmlType="submit"
              ...
              <h1 className="my-3 text-[16px] col-span-2">
          ...
          <p className="text-teal-600 text-right text-[16px] mt-2">
            Forgot Password
          </p>
