...
export default function Register() {
  ...
  async function handleSubmit(value: signup) {
    const { fullname, username, phonenumber, email, password, comfirpassword } =
      value;
    ...
    if (password === comfirpassword) {
      ...
      messageApi.open({
        type: "error",
        content: "Re-entered password is incorrect",
      });
    }
  }
  ...
  return (
    <>
      {contextHolder}
      <div
        className="bg-white shadow-2xl max-w-[1300px] mx-auto rounded-xl overflow-hidden 
      ...
      >
        <div className="col-span-6 ">
          <img
            className="h-full"
            src="https://cf.bstatic.com/static/img/twitter-image-else/566c7081f1deeaca39957e96365c3908f83b95af.jpg"
          ></img>
        </div>
        <div className="p-[30px] col-span-5 ">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-x-2">
              ...
              <Form.Item label="ComfirPassword">
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Please input your ComfirPassword!",
                    },
                  ]}
                >
                  <Input.Password />
              ...
              <Form.Item className="col-span-2 mx-auto my-6">
                <Button
                  type="primary"
                  htmlType="submit"
