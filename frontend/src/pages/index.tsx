...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    (async () => {
      const getToken = await JSON.parse(
    ...
    <div className="overflow-hidden">
      <div className="border-left select-none mb-28 ">
        ...
        <div className="h-[906px] relative">
          <div
            className="absolute top-1/2 left-10 -translate-y-1/2 bg-teal-600 rounded-full z-10 cursor-pointer items-center"
            onClick={prevSlide}
          >
            <ChevronLeftIcon className="h-12 w-12 text-white " />
          </div>
          <div
            className="w-full h-full object-center bg-cover bg-no-repeat bg-center transition-all duration-500 "
            style={{ backgroundImage: `url(${slider[currentIndex].url})` }}
          />
          <div className="absolute top-0 w-full h-full bg-neutral-800 opacity-30"></div>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-center ">
            ...
            <p>
              ...
              similique porro aperiam. Accusantium tempora eveniet explicabo.
              Officia hic vel cum quia tempora unde sit quod eligendi
              reiciendis? Amet, aliquam laudantium.
            </p>
          </div>

          <div
            className="absolute top-1/2 right-10 -translate-y-1/2 bg-teal-600 rounded-full z-10 cursor-pointer"
            onClick={nextSlide}
          >
        ...
        <div className="relative font-serif ">
          ...
          />
          <div
            className="absolute -top-16 flex h-[143px] rounded bg-white left-1/2 -translate-x-1/2 w-[1300px] justify-around text-lg
          ...
          >
            ...
            <div className="flex flex-col ml-2 ">
              ...
              <div className="hover:border-[#4096ff] flex w-[150px] h-10 justify-around mt-3 items-center border-[1px] rounded-lg border-[#d9d9d9]  lg:w-[110px]">
                ...
                <p>{numberAduts}</p>
                <PlusCircleIcon
                  onClick={() => setNumberAduts((prev) => prev + 1)}
                  className="h-6 w-6 text-gray-500"
                />
              </div>
            </div>
            <div className="flex flex-col ml-2">
              ...
              <div className="flex w-[150px] h-10 justify-around mt-3 items-center border-[1px] rounded-lg border-[#d9d9d9] hover:border-[#4096ff] lg:w-[110px]">
                ...
                <p>{numberChilren}</p>
                <PlusCircleIcon
                  onClick={() => setNumberChilren((prev) => prev + 1)}
                  className="h-6 w-6 text-gray-500"
                />
              </div>
            </div>
      ...
      <div className="h-max my-36">
        <div className="mt-32 flex flex-col items-center">
          ...
          <p className="text-[40px] font-medium mb-2">
            Explore <span className="text-teal-600">Top Destination</span>
          </p>
          <p className="w-[900px] lg:w-[500px] text-center text-[#6d6d6d] mb-12">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga
            laboriosam dolores consequuntur unde rerum eligendi, aspernatur
            tempora nesciunt ea beatae quaerat.
          </p>
          <div className="flex w-[1300px] justify-between xl:w-full xl:justify-evenly">
            <div className="flex flex-col ">
              <div className="relative group">
                <h1 className="absolute text-[30px] text-white left-1/2 -top-5 -translate-y-1/2 -translate-x-1/2 group-hover:top-1/2 z-10 transition-all duration-300">
                  Hà Nội
                </h1>
                <img
                  src="https://reviewvilla.vn/wp-content/uploads/2022/05/kinh-nghiem-du-lich-ha-noi-5-1024x577.jpg"
                  className="w-[734px] lg:w-[390px] 2xl:w-[570px] rounded-[20px] hover:scale-105 transition-all duration-300"
                ></img>
              </div>

              <div className="flex justify-between mt-[30px] lg:mt-[10px] lg:w-[390px] 2xl:w-[570px]  2xl:mt-[20px]">
                <div className="relative group">
                  <h1 className="absolute text-[30px]  lg:text-[20px] -z-10  text-white left-1/2 -top-5 -translate-y-1/2 -translate-x-1/2 group-hover:top-1/2 group-hover:z-10 transition-all duration-300">
                    Sài gòn
                  </h1>
                  <img
                    src="https://i.doanhnhansaigon.vn/2020/04/29/thumbnailsaigon-1588134021_750x0.jpg"
                    className="w-[352px] lg:w-[190px] 2xl:w-[270px] h-full rounded-[20px] hover:scale-105 transition-all duration-300"
                  ></img>
                </div>
                ...
                <div className="relative group">
                  ...
                  <img
                    src="https://vnn-imgs-f.vgcloud.vn/2021/09/19/17/c36d4bf878038e5dd712.jpg"
                    className="w-[352px] lg:w-[190px] 2xl:w-[270px] rounded-[20px] hover:scale-105 transition-all duration-300"
                  ></img>
                </div>
              </div>
            </div>
            ...
            <div className="w-[520px] relative group z-10 lg:w-[300px] 2xl:w-[430px]">
              ...
              <img
                src="https://static.vinwonders.com/2022/05/OpAU9ZpU-du-lich-da-nang-thang-9-2.jpeg"
                className="h-full  rounded-[20px]  hover:scale-105 transition-all duration-300"
              ></img>
            </div>
          </div>
        </div>
        <div className=" pb-8  flex flex-col items-center bg-[#f1f1f1]">
          <div
            className="w-full h-[250px] xl:h-[150px] "
            style={{
          ...
          <div className="w-[1300px] xl:w-[800px]  pl-[10px] xl:text-center mb-8">
            ...
            <p className="w-[600px] xl:w-[400px] text-[#6d6d6d] xl:inline-block">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga
              laboriosam dolores consequuntur unde rerum eligendi
            </p>
          </div>
          <Resizable></Resizable>
        </div>
        <div className=" py-32 xl:py-20 flex justify-center ">
          <div className="w-[1300px] flex z-10 justify-between  2xl:w-[1000px] lg:w-[800px] xl:flex-col xl:items-center ">
            <h1 className="text-[28px] xl:mb-5  w-[350px] ml-[10px] italic uppercase font-medium underline underline-offset-4 decoration-4 decoration-teal-600">
              What makes our hotels best than others?
            </h1>
            <div className="flex ">
              <div
                className="flex w-1/3 p-5 border-[1px] rounded-lg mx-3 group hover:before:w-full hover:before:h-full hover:before:opacity-100 
              ...
              >
                <div>
                  <HandThumbUpIcon className="h-10 w-10 text-[#4096ff] bg-[#4096ff3d] p-2 rounded-[50%] inline-flex group-hover:bg-white lg:bg-white " />
                </div>
                <div className="ml-3 ">
                  <h1 className="font-medium text-[20px] mb-1 group-hover:text-white duration-1000 lg:text-white">
                    Hassle free Booking
                  </h1>
                  <p className="text-[#6d6d6d] group-hover:text-white lg:text-white">
                    Book hotels from our website without ant hassle
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div>
                  <StarIcon className="h-10 w-10 text-[#FF8C32] bg-[#ff8b323d] p-2 rounded-[50%] inline-flex group-hover:bg-white lg:bg-white" />
                </div>
                <div className="ml-3">
                  <h1 className="font-medium text-[20px] mb-1 group-hover:text-white duration-1000 lg:text-white">
                    28,000 Reviews
                  ...
                  <p className="text-[#6d6d6d] group-hover:text-white lg:text-white">
                    Book hotels from our website withiyt any hassle
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div>
                  <PhoneIcon className="h-10 w-10 text-[#019267] bg-[#0192673d] p-2 rounded-[50%] inline-flex group-hover:bg-white lg:bg-white" />
                </div>
                <div className="ml-3">
                  <h1 className="font-medium text-[20px] mb-1 group-hover:text-white duration-1000 lg:text-white ">
                    24/7 Support
        ...
        <div className="mt-20 flex justify-center bg-[#dbdbdb47] xl:bg-white py-10 xl:mt-0">
          <div className="w-[1300px] flex flex-col xl:w-[800px]">
            <h1 className="text-[28px] ml-[10px] text-center italic uppercase font-medium underline underline-offset-4 decoration-4 decoration-teal-600">
